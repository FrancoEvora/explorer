...
export const CONQUEST_VERSION='solaris-conquista-v2.2';
export function installConquest(outDir='solaris-dist') {
  const out=path.resolve(outDir),source=path.resolve('site/conquista');
  const files=['index.html','conquista.css','paths.js','music.js','audio.js','conquista.js'];
  ...
  for(const f of ['paths.js','music.js','audio.js','conquista.js'])new vm.Script(texts[f]);
