...
const VERSION='2026-09-25-solaris-lots-v1';
const solarisFiles=['index.html','styles.css','app.js','lots-data.js','assets/masterplan.webp','assets/lotes.webp','assets/portaria.webp','assets/clube.webp','assets/lago.webp'];
...
for(const file of ['app.js','lots-data.js'])new vm.Script(fs.readFileSync(path.join(source,file),'utf8'));
...
fs.writeFileSync(path.join(out,'version.json'),JSON.stringify({version:VERSION,blocks:10,lots:249,institutionalLot:'C18',perspectives:4,newRenders:3,gameEnabled:false,musicEnabled:false,lotSource:'Solaris_Home_Resort_Urbanistico_22-07-25',lotLayer:'schematic identification',metropolitanPreserved:true}));
